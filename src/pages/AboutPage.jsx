      ...
      <section className="pt-44 pb-12 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center" data-aos="fade-up">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Tentang Nature Coffee</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div 
              className="rounded-2xl w-full h-80 sm:h-96 bg-cover bg-no-repeat bg-center shadow-lg lg:order-1"
              style={{
            ...
            <div data-aos="fade-left" className="lg:order-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-900">Kualitas Premium</h3>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-900">Pelayanan Tulus</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-900">Komunitas</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-900">Konsistensi</h3>
              <p className="text-gray-600">
